...
foreach($returnData as $outcome){
    ...
    echo '<td><a style="float: right" href="editCategory.php?category_Id=' . $outcome->category_Id . '">Edit</a></td>';
    echo '<td><a style="float: right" href="deleteCategory.php?category_Id=' . $outcome->category_Id . '">Delete</a></td>';
